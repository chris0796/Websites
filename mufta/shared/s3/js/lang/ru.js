...
window._s3Lang['JS_MOSAIC_DATA_EDIT_HINT'] = "Нажмите для редактирования";
...
window._s3Lang['JS_MOSAIC_HISTORY_BACK'] = "Назад (Ctrl + Z)";
window._s3Lang['JS_MOSAIC_HISTORY_FORWARD'] = "Вперед (Ctrl + Shift + Z)";
...
window._s3Lang['JS_MOSAIC_NOTE_IMAGE_CHOOSE'] = "Выбрать картинку";
window._s3Lang['JS_MOSAIC_NOTE_LINK_EDIT'] = "Редактировать ссылку";
window._s3Lang['JS_MOSAIC_NOTE_PARAMS'] = "Редактировать параметры";
window._s3Lang['JS_MOSAIC_NOTE_PARAMS_TITLE'] = "Правый клик";
window._s3Lang['JS_MOSAIC_NOTE_PARENT_PARAMS'] = "Редактировать параметры родителя";
window._s3Lang['JS_MOSAIC_NOTE_PUBLISH'] = "Применить изменения к сайту";
window._s3Lang['JS_MOSAIC_NOTE_TEXT_EDIT'] = "Изменить текст";
window._s3Lang['JS_MOSAIC_NOTE_TEXT_TITLE'] = "Двойной клик";
window._s3Lang['JS_MOSAIC_NOTE_VISIBILITY_SETTINGS'] = "Параметры отображения";
window._s3Lang['JS_MOSAIC_PUBLISH'] = "Опубликовать";
window._s3Lang['JS_MOSAIC_PUBLISHED'] = "Опубликовано";
window._s3Lang['JS_MOSAIC_PUBLISHING'] = "Публикация...";
